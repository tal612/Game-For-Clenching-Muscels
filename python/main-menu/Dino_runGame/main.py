            ...
            if pygame.display.get_surface() == None:
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.KEYDOWN:
                        ...
                        if event.key == pygame.K_DOWN or event.key == pygame.K_DOWN:
...
def arduino_communication():
    print("check")
    serial_ = serial.Serial('COM8', baudrate=9600, timeout=1)
    print("connected")
    pressed = False
    ...
    while True:
        ...
        if msg:
            ...
            if msg == b'J':
                jump = pygame.event.Event(pygame.KEYDOWN, {'key':pygame.K_SPACE})
                #print("jump")
                ...
                un_crouch = pygame.event.Event(pygame.KEYUP, {'key': pygame.K_DOWN})
                pygame.event.post(un_crouch)
