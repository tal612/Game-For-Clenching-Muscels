...
import math, pygame, sys, os, copy, time, random, subprocess, threading
...
class Arrow(pygame.sprite.Sprite):
    ...
    def update(self, direction):
        ...
        if direction == RIGHT:
            ...
            self.angle = (self.angle - ANGLE_SPEED) % 180

        self.transformImage = pygame.transform.rotate(self.image, abs(self.angle))
...
def main(threshold):
    ...
    global FPSCLOCK, DISPLAYSURF, DISPLAYRECT, MAINFONT,t1, t_settings
    ...
    while True:
        ...
        to_exit = endScreen(score, winorlose)
        if to_exit:
            return
